...
mod test {
    ...
    fn test_get_cyphertext() {
        ...
        let ms: Vec<Integer> = [
            ...
            .collect();
        let r = Integer::from_hexa_string(
        ...
        let phis: Vec<Integer> = [
            ...
            .collect();
        let c_res =
            Ciphertext::get_ciphertext(&EncryptionParameters::from((&p, &q, &g)), &ms, &r, &pks);
        assert!(c_res.is_ok());
        let c = c_res.unwrap();
    ...
    fn test_get_cyphertext_product() {
        ...
        let g = Integer::from(4u8);
        let gamma_a = Integer::from_hexa_string(
        ...
        let phis_a: Vec<Integer> = [
            ...
            .map(|s| Integer::from_hexa_string(s).unwrap())
            .collect();
        let gamma_b = Integer::from_hexa_string(
        ...
        let phis_b: Vec<Integer> = [
            ...
            .map(|s| Integer::from_hexa_string(s).unwrap())
            .collect();
        let gamma_res = Integer::from_hexa_string(
