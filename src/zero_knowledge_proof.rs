...
mod test {
    ...
    fn test_verify_schnorr_check_wrong() {
        ...
        if cfg!(feature = "checks") {
            assert!(verify_schnorr(&EncryptionParameters::from((&p, &q, &g)), (&e, &z), &y, &add_info).is_err())
        } else {
            assert!(verify_schnorr(&EncryptionParameters::from((&p, &q, &g)), (&e, &z), &y, &add_info).is_ok())
        }
    }
    ...
    fn test_verify_schnorr_2048() {
        ...
        let y = BigUint::from_hexa_string("").unwrap();
        let add_info: Vec<String> = vec!["test-0".to_string()];
        assert!(verify_schnorr(&EncryptionParameters::from((&p, &q, &g)), (&e, &z), &y, &add_info).unwrap())
    }
    ...
    fn test_verify_exp_2048() {
        ...
        let add_info: Vec<String> = vec!["test-0".to_string()];
        assert!(verify_exponentiation(&EncryptionParameters::from((&p, &q, &g)), &gs, &ys, (&e, &z), &add_info).unwrap())
    }
