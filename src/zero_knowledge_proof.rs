...
fn compute_phi_schnorr(ep: &EncryptionParameters, x: &MPInteger) -> MPInteger {
...
mod test {
    ...
    fn test_verify_schnorr_check_wrong() {
        let p = MPInteger::from(12u8);
        let q=  MPInteger::from_hexa_string("").unwrap();
        ...
        .unwrap();
        let z = MPInteger::from_hexa_string("").unwrap();
        let y = MPInteger::from_hexa_string("").unwrap();
    ...
    fn test_verify_schnorr_3072() {
        let p = MPInteger::from_hexa_string("").unwrap();
        let q = MPInteger::from_hexa_string("").unwrap();
        let g = MPInteger::from_hexa_string("0x4").unwrap();
        let e = MPInteger::from_hexa_string(
            "0xFE6B909E2C4EC3C9A25315EAF1E99A50452BBD22E75A69C247147E23669D665F",
        )
        .unwrap();
        let z = MPInteger::from_hexa_string("").unwrap();
        let y = MPInteger::from_hexa_string("").unwrap();
    ...
    fn test_verify_exp_3072() {
        ...
        .unwrap();
        let z = MPInteger::from_hexa_string("").unwrap();
        let add_info: Vec<String> = vec!["test-0".to_string()];
    ...
    fn test_verify_exp_3072_2() {
        ...
        .unwrap();
        let z = MPInteger::from_hexa_string("").unwrap();
        let add_info: Vec<String> = vec!["test-0".to_string(), "test-1".to_string()];
        assert!(verify_exponentiation(
            &EncryptionParameters::from((&p, &q, &g)),
            &gs,
    ...
    fn test_verify_exp_3072_7() {
        ...
        .unwrap();
        let z = MPInteger::from_hexa_string("").unwrap();
        let add_info: Vec<String> = vec!["test-0".to_string(), "test-1".to_string()];
        assert!(verify_exponentiation(
            &EncryptionParameters::from((&p, &q, &g)),
            &gs,
