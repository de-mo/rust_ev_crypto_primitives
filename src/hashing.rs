...
mod test {
    ...
    #[test]
    fn test_mp_integer() {
        let i = MPInteger::from_hexa_string("").unwrap();
    ...
    fn test_mix_content() {
        let mut l: Vec<HashableMessage> = vec![];
        l.push(HashableMessage::from("common reference string"));
        let bi1 = MPInteger::from_hexa_string("").unwrap();
        l.push(HashableMessage::from(&bi1));
        let bi2 = MPInteger::from_hexa_string("").unwrap();
    ...
    fn test_mixed_content_nested() {
        ...
        let mut l: Vec<HashableMessage> = vec![];
        l.push(HashableMessage::from("common reference string"));
        let bu3=MPInteger::from_hexa_string("").unwrap();
        l.push(HashableMessage::from(&bu3));
        let bu4 = MPInteger::from_hexa_string("").unwrap();
    ...
    fn test_hashed() {
        let mut nl: Vec<HashableMessage> = vec![];
        let bu1 = MPInteger::from_hexa_string("0x4").unwrap();
        nl.push(HashableMessage::Hashed(HashableMessage::from(&bu1).hash()));
        let bu2= MPInteger::from_hexa_string("").unwrap();
        nl.push(HashableMessage::from(&bu2));
        let mut l: Vec<HashableMessage> = vec![];
        l.push(HashableMessage::from("common reference string"));
